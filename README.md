...
[![License](https://img.shields.io/npm/l/@iungo/nx-plugin-openapi)]()
...
- 🤖 [@iungo/nx-plugin-openapi](packages/nx-plugin-openapi/README.md)  
  Keep your API spec files in libs, and auto-generate sources
- 🧽 [@iungo/nx-plugin-unused-deps](packages/nx-plugin-unused-deps/README.md)  
